...
// query input data
$query= "INSERT INTO detail_sipu VALUES (null,'$detail_sipu_id_sipu','$detail_sipu_nama_barang','$detail_sipu_spesifikasi','$detail_sipu_jumlah','$detail_sipu_harga_satuan','$detail_sipu_keterangan');";
