...
$query = "SELECT permohonan.*, akun.nama_lengkap, sipu.* FROM permohonan INNER JOIN akun ON permohonan.id_akun_pemohon=akun.id_akun INNER JOIN sipu ON permohonan.id_sipu=sipu.id_sipu WHERE permohonan.id_permohonan='".$_GET['id_permohonan']."'";
